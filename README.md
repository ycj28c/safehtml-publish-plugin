...
# How to install
1. Manage Jenkins -> plugin Manager -> upload the "insight-benchmark-report-plugin.hpi" 
...
2. In your jenkins job, Add Post-build action 
...
4. The new report button will show up in your jenkins jobs
